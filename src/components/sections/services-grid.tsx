...
function ServiceCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group/feature relative flex flex-col py-10 lg:border-r border-neutral-200",
    ...
    >
      ...
      <div className="relative z-10 mb-4 px-10 text-neutral-500">
        {icon}
      </div>
      ...
      <p className="relative z-10 max-w-xs px-10 text-sm text-neutral-500 leading-relaxed">
        {description}
      </p>
    </motion.div>
  );
